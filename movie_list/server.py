...
#########################################################################################
# Info:                                                                                 #
# Uses MovieDB API to display a list of your favorite movies on rotating cards.         #
# The front has the movie poster, and the back has your review and the movie info.      #
#                                                                                       #
# MovieDB API Setup:                                                                    #
# Signup for free API key: https://www.themoviedb.org/signup                            #
# Enter your API key in code below: MOVIE_DB_API_KEY = 'ENTER-API-KEY'                  #
#                                                                                       #
# Setup & Requirements:                                                                 #
# rename project folder e.g. movie_list: cd movie_list                                  #
...
# Flask requires you make up a key: app.config['SECRET_KEY'] = 'ENTER-FLASK-KEY'        #
#                                                                                       #
...
MOVIE_DB_API_KEY = 'ENTER-API-KEY'
MOVIE_DB_SEARCH_URL = "https://api.themoviedb.org/3/search/movie"
MOVIE_DB_INFO_URL = "https://api.themoviedb.org/3/movie"
MOVIE_DB_IMAGE_URL = "https://image.tmdb.org/t/p/w500"

app = Flask(__name__)
app.config['SECRET_KEY'] = 'ENTER-FLASK-KEY'
Bootstrap(app)
