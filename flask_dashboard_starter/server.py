...
#########################################################################################
# Info:                                                                                 #
# Users can register/sign in and access dashboard to downloadable files.                #
#                                                                                       #
# Setup & Requirements:                                                                 #
# rename project folder e.g. flask_dashboard: cd flask_dashboard                        #
...
# Install Werkzeug Security: pip install Werkzeug                                       #
